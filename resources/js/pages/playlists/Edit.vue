...
import { index, show, update } from '@/routes/playlists';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: show(props.playlist.id).url,
    },
    {
        title: 'Edit Playlist',
        href: '#',
...
const submit = () => {
    router.put(update(props.playlist.id).url, form.value, {
        onStart: () => {
...
onMounted(() => {
    // Pre-populate form with existing playlist data
    form.value.name = props.playlist.name;
    form.value.description = props.playlist.description || '';
    form.value.is_public = props.playlist.is_public;
    form.value.track_ids = props.playlist.tracks.map(track => track.id);
});
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center gap-4 mb-6">
            <Button variant="ghost" size="sm" as-child>
                <a :href="show(props.playlist.id).url">
            ...
            <div>
                ...
                <p class="text-muted-foreground">Update your playlist details and tracks</p>
            </div>
        </div>
            ...
            <div class="lg:col-span-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the basic information for your playlist
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-6">
                        <Form
                            v-bind="update.form(props.playlist.id)"
                        ...
                        >
                            ...
                            <div class="flex justify-end gap-3">
                                <Button
                                    ...
                                    as-child
                                >
                                    <a :href="show(props.playlist.id).url">Cancel</a>
                                </Button>
                                <Button
                                    type="submit"
                                    :disabled="form.processing"
                                >
                                    {{ form.processing ? 'Updating...' : 'Update Playlist' }}
                                </Button>
                            </div>
                        </Form>
                    </CardContent>
